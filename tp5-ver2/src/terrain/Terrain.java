...
public class Terrain {
	...
	private static final double SECOND_ESCAPE_MULT = 1.1;
	...
	private List<Wall> generateWalls() {
		...
		//walls.add(new Wall(new Vector2d(0, L), new Vector2d(W, L))); // bottom full
		return walls;
	}	
	...
	public boolean escapedRoom(final Particle particle) {
		return particle.getPosition().y > L * SECOND_ESCAPE_MULT;
	}
