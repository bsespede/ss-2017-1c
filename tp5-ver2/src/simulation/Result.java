...
public class Result {
	...
	public Result(final Map<Double, Integer> discharges, final Map<Double, Double> meanFlow, final Map<Double, Double> kineticEnergy, final Map<Double, Double> flow, final Map<Double, Double> pressure) {
