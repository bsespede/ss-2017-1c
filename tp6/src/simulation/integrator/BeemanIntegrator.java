...
public class BeemanIntegrator implements Integrator {
	...
	public void move(final Particle particle, final List<Particle> particles, final Terrain terrain, final double dt) {
        ...
        final Particle previous = new Particle(particle.getId(), particle.getPrevPosition(), particle.getPrevVelocity(), particle.getDesiredVelocity(), particle.getMass(), particle.getRadius());
