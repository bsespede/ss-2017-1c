...
public class BeemanIntegrator implements Integrator{
	...
	public void move(final Particle particle, final List<Particle> particles, final double dt) {
        ...
        final Particle previous = new Particle(particle.getName(), particle.getPrevPosition(), particle.getPrevVelocity(), particle.getRadius(), particle.getMass());
        ...
        particle.setVelocity(particle.getNextPosition());
        particle.setNextVelocity(nextVelocity);
    }
